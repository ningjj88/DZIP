 ...
 * @since 2010-6-10
 */
public abstract class Abstract4Test8583ToHost {

	private static String HOST_IP = "192.168.20.221";
	private static int HOST_PORT = 6301;
	private static String PATH = "/packets/dzip/fromATM";
...
//		tf.setParsers(pmap);
	...
	public void send(Map map) throws Exception {
		...
		Transformer f = tf.getTransformer("OutboundPacket_bak");
...
//				+ sb.toString() + new String(body, "GB18030"));
		System.err.println("recv =====>" +new String(sndBuffer,"GB18030"));
		Transport transport = getTransport();
		byte[] rcvBuffer = (byte[]) transport.submit(sndBuffer);
		System.err.println("recv =====>" +new String(rcvBuffer,"GB18030"));
		Transformer p = tf.getTransformer("OutboundPacketRes_bak");
	...
	public Abstract4Test8583ToHost() {
		super();
	}
