...
/**
 *@ClassName:&{type_name}
 *@Description:他行POS消费冲正
 *@author :chenshq
 *@date：2010-08-16
 */
public class PosConsumeReversalAction extends DzipBaseAction {
	private UpdateJoural updateJoural;
	private ActionUtilProcessor utilProcessor;

	@SuppressWarnings("unchecked")
	public void execute(final Context ctx) throws PeException {
		logger.info("JCK PosConsumeReversalAction ==================>Start");
		...
		if(count>0){
			...
			logger.info("JCK消费冲正上笔交易信息(resultMap)==================>"+resultMap);
