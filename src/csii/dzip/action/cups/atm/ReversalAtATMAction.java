...
public class ReversalAtATMAction extends DzipBaseAction {
	...
	public void execute(final Context ctx) throws PeException {
		logger.info("CUPS ReversalAtATMAction ==================>Start");
		...
		if(count>0){
			...
			logger.info("CUPS取款冲正上笔交易信息(resultMap)==================>"+resultMap);
			...
			if(Constants.PE_ONE.equals((String)ctx.getData(Constants.PE_OUTSIDEFLAG))){//境外交易
				if(ctx.getData(Constants.ISO8583_CHDAMT)==null)//F6为null,交易金额为取款交易金额
