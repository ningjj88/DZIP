 ...
 *@date：20112-03-017
 */
public class CollectionReversalAction extends DzipBaseAction {
	private UpdateJoural updateJoural;
	private ActionUtilProcessor utilProcessor;

	@SuppressWarnings("unchecked")
	public void execute(final Context ctx) throws PeException {
		logger.info("CUPS CollectionReversalAction ==================>Start");
		...
		if(count>0){
			...
			logger.info("CUPS代收冲正上笔交易信息(resultMap)==================>"+resultMap);
