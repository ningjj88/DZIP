 ...
 * @desc 下载文件处理查询
 */
public class QueryImportFileInfoAction extends DzipBaseAction{
	private AuditProcessor auditProcessor;

	@SuppressWarnings("unchecked")
	public void execute(Context ctx) throws PeException {
		logger.info("QueryImportFileInfoAction==========================>Start");
...
//			listRecord = ConvertUtilProcessor.auditConvert(listRecord);
			...
			throw new PeException(Errors.QUERY_IMPORT_FILE_INFO_FAILED);
