 ...
 *@date：2010-6-29
 */
public class DepositConfirm4ATMAction extends DzipBaseAction {
	...
	public void execute(final Context ctx) throws PeException {
		logger.info("DepositConfirm4ATMAction========================>Start");
		/*
		 * 当发生存款确认交易时，首先取出8583报文中的90#域值， 该域中包含上笔交易的索引信息。 通过该域的信息查询上笔交易是否
		 * 成功， 如果已经成功，直接返回成功信息； 否则，调用核心存储过程执行存款操作。
		 */
		...
		logger.info("CUPS存款确认上笔交易信息(resultMap)==================>"+resultMap);
