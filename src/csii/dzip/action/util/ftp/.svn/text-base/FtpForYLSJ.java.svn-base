...
public class FtpForYLSJ {
	 ...
	 * @throws PeException 
	 */
	public boolean download(String remoteFile, String localFile, String postDate) throws PeException {
		boolean flag =true;
		try {
			this.remotePath = this.remotePath + postDate + "/";
