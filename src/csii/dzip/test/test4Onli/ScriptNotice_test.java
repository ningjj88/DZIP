 ...
 */
public class ScriptNotice_test extends Abstract4TestOnliToHost {

	@SuppressWarnings("unchecked")
	@Override
	protected Map prepare() {
		Map map = new HashMap();
		map.put("_TransactionCode","onli.ScriptNotice");
	    map.put(Constants.ISO8583_ACCTNO,"6212339010100009642");                                /* 2#  n..19 LLVAR */
	    map.put(Constants.ISO8583_PRO_CODE, "600000");
	    ...
	    map.put(Constants.ISO8583_RESCODE, "00");
	    ...
	    map.put(Constants.ISO8583_NET_MAN_INF_CODE, "951");
...
//		System.out.println("000005100600000000000002300".substring(8, 10));
		ScriptNotice_test testCase = new ScriptNotice_test();
		testCase.test();
	}
