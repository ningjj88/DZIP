 ...
 */
public class CashRecharge4Credit4LoadCancel_test extends Abstract4TestOnliToHost {

	@SuppressWarnings("unchecked")
	@Override
	protected Map prepare() {
		Map map = new HashMap();
		map.put("_TransactionCode","onli.CashRecharge4Credit4LoadCancel");
	    ...
	    map.put(Constants.ISO8583_ORGDATA, "042000000301161553160000557675000005576750");//消息类型(4)+系统跟踪号(6)+交易日期时间(10)+32#+33#(11不足补零)
