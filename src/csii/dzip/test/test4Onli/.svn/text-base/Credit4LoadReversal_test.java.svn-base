 ...
 * 柜面指定账户圈存冲正测试
 * @author xiehai
 * @date 2014-1-14 下午01:29:05
 */
public class Credit4LoadReversal_test extends Abstract4TestOnliToHost {

	@SuppressWarnings("unchecked")
	@Override
	protected Map prepare() {
		Map map = new HashMap();
		map.put("_TransactionCode","onli.Credit4LoadReversal");
	    ...
	    map.put(Constants.ISO8583_SYSTRACENUM, "000005");                   /*11# n6 */
	    ...
	    map.put(Constants.ISO8583_ORGDATA, "020000000201141454270000557675000005576750");//消息类型(4)+系统跟踪号(6)+交易日期时间(10)+32#+33#(11不足补零)
