...
/**
 * ATM指定账户圈存测试(本代本、本代他走的一个流程)
 * @author xiehai
 * @date 2013-12-10 上午09:33:16
 */
public class Credit4Load_test extends Abstract4Test8583ToHost implements Runnable{
	@SuppressWarnings("unchecked")
	@Override
	protected Map prepare() {
		Map map=new HashMap();
	    map.put(Constants.ISO8583_TRANSACTION_ID,"020060");
