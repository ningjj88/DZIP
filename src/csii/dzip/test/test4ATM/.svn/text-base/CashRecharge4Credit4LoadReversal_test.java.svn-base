...
/**
 * ATM现金充值圈存冲正测试(本代本、本代他走的一个流程)
 * @author xiehai
 * @date 2013-12-12 上午10:58:26
 */
public class CashRecharge4Credit4LoadReversal_test extends Abstract4Test8583ToHost {
	@SuppressWarnings("unchecked")
	@Override
	protected Map prepare() {
		Map map=new HashMap();
	    map.put(Constants.ISO8583_TRANSACTION_ID,"042063");
	    ...
	    map.put(Constants.ISO8583_TRANAMT,"99");                                               /* 4# n12 */
	    ...
	    map.put(Constants.ISO8583_LOCTRANSTIME, "111551");        /*12# n6(hhmmss) */
	    ...
	    map.put(Constants.ISO8583_ORGDATA, "020011155112161115510000557675000005576750");//消息类型(4)+系统跟踪号(6)+交易日期时间(10)+32#+33#(11不足补零)
	    map.put(Constants.ISO8583_RCVCODE, "00010000"); //100#
	    map.put(Constants.ISO8583_MESAUTHCD, "EEEEEEEE");   //128#
	    return map;
	}
	public static void main(String[] args) throws Exception {
		CashRecharge4Credit4LoadReversal_test testCase = new CashRecharge4Credit4LoadReversal_test();
		testCase.test();
	}
