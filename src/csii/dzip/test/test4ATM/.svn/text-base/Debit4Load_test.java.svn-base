 ...
 */
public class Debit4Load_test extends Abstract4Test8583ToHost {

	@SuppressWarnings("unchecked")
	@Override
	protected Map prepare() {
		Map map=new HashMap();
	    map.put(Constants.ISO8583_TRANSACTION_ID,"010061");
	    ...
	    map.put(Constants.ISO8583_PINDATA,"111110");                                          /*52# LLL*/
	...
	public static void main(String[] args) throws Exception {
		Debit4Load_test testCase = new Debit4Load_test();
		testCase.test();
	}
