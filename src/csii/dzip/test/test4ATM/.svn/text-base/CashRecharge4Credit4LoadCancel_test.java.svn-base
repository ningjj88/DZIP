...
/**
 * ATM现金充值圈存撤销测试(本代本、本代他走的一个流程)
 * @author xiehai
 * @date 2013-12-10 上午09:33:16
 */
public class CashRecharge4Credit4LoadCancel_test extends Abstract4Test8583ToHost implements Runnable{
	@SuppressWarnings("unchecked")
	@Override
	protected Map prepare() {
		Map map=new HashMap();
	    map.put(Constants.ISO8583_TRANSACTION_ID,"020017");
	...
	public static void main(String[] args) throws Exception {
		CashRecharge4Credit4LoadCancel_test testCase = new CashRecharge4Credit4LoadCancel_test();
		testCase.test();
	}
