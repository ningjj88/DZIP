...
/**
 * ATM现金充值圈存撤销冲正测试(本代本、本代他走的一个流程)
 * @author xiehai
 * @date 2013-12-10 上午09:33:16
 */
public class CashRecharge4Credit4LoadCancelReversal_test extends Abstract4Test8583ToHost implements Runnable{
	@SuppressWarnings("unchecked")
	@Override
	protected Map prepare() {
		Map map=new HashMap();
	    map.put(Constants.ISO8583_TRANSACTION_ID,"042017");
	    ...
	    map.put(Constants.ISO8583_PRO_CODE,"170000");                                     		/* 3# n6 */
...
//	    map.put(Constants.ISO8583_ICCSYSRELDATA, Util.HexToString("9F100807010199A0B806019F360201C2950500001800009F1E083230303331323331DF31050000000000"));
	    ...
	    map.put(Constants.ISO8583_ORGDATA, "020011364412161136440000557675000005576750");//消息类型(4)+系统跟踪号(6)+交易日期时间(10)+32#+33#(11不足补零)
	...
	public static void main(String[] args) throws Exception {
		CashRecharge4Credit4LoadCancelReversal_test testCase = new CashRecharge4Credit4LoadCancelReversal_test();
		testCase.test();
	}
