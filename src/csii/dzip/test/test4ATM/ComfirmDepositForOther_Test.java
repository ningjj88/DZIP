 ...
 * @since 2010-7-9
 */
public class ComfirmDepositForOther_Test extends Abstract4Test8583ToHost  implements Runnable {
...
//	    map.put(Constants.ISO8583_SETDATE,"0820");                                              /*15# s4 */
	    ...
	    map.put(Constants.ISO8583_ORGDATA,"020014044511091404450000004221000000012210");        /*90# LLL*/
		return map;
	}
