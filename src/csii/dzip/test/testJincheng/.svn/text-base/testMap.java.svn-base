...
//		map.put("PROC", "211000");
//		map.put("AMT", "700");
		map.put("TRDT", Util.getDateString("MMdd") + Util.getDateString("HHmmss"));
		map.put("TRAC",Util.getDateString("HHmmss"));
		map.put("LOCT", Util.getDateString("HHmmss"));
		map.put("LOCD", Util.getDateString("MMdd"));
		map.put("EXPI", "");
		map.put("SETT", Util.getDateString("MMdd"));
		map.put("MERC", "6011");
		map.put("POSE", "021");
		map.put("POSC", "02");
		map.put("POSP", "06");
		map.put("FEE", "");
		map.put("ACQU", "01000344");
		map.put("FORW", "01000447");
		map.put("TRACK2", "6221359010100080508=0000201158=");
		map.put("TRACK3", "");
