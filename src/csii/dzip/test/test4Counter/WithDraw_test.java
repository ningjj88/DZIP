 ...
 * @since 2010-8-16
 */
public class WithDraw_test extends Abstract4TestCounterXMLToHost {
	...
	protected Map prepare() {
		Map map = new HashMap();
		map = testMap.getMap();
		map.put(Constants.ISO8583_TRANSACTION_ID,"019702");  
		map.put("MESG", "0200");
	...
	public static void main(String[] args) throws Exception {
		WithDraw_test testCase = new WithDraw_test();
		testCase.test();
	}
