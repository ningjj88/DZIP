...
public class EstablishEntrust_test  extends Abstract4TestCUPS8583ToHost {
	...
	protected Map prepare() {
		...
		map.put(Constants.ISO8583_HEAD_TX_TYPE, "0100");
		 ...
		 // 9999990000438323本行卡
		map.put(Constants.ISO8583_TRANSACTION_ID,"010089");                                     
	    map.put(Constants.ISO8583_ACCTNO,"6221359010100538232");                                /* 2#  n..19 LLVAR */
	    map.put(Constants.ISO8583_PRO_CODE,"890000");                                           /* 3# n6 */                                                          
	    ...
	    map.put(Constants.ISO8583_ADDDATAPRI,"151ASAO00201PZ137010000                                    111122220003333                                    44455555555555566666666666620110901-20111031");                  /*48# ans40*/    
	    map.put(Constants.ISO8583_PINDATA,"111111");                  						    /*52# b64*/
	    map.put(Constants.ISO8583_SECURCONTRINFO,"2600000000000000");                           /*53# n16*/
	    map.put(Constants.ISO8583_REACODE,"027000002000500000000000111000");                          		/*60# n16*/
	...
	public static void main(String[] args) throws Exception {
		EstablishEntrust_test testCase = new EstablishEntrust_test();
		testCase.test();
	}
