 ...
 */
public class CloseAccountSettleReversal_test extends Abstract4TestPlatformAdminToHost {

	@Override
	@SuppressWarnings("unchecked")
	protected Map prepare() {
		Map map = new HashMap();
		map.put("_TransactionCode", "platformAdmin.CloseAccountSettleReversal");
		...
		map.put(Constants.PE_TRANDATETIME, "");
	...
	public static void main(String[] args) throws Exception {
		CloseAccountSettleReversal_test testCase = new CloseAccountSettleReversal_test();
		testCase.test();
	}
